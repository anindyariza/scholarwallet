...
function generateLocalAiReply(message: string): string {
  ...
  return "Maaf, saat ini AI utama tidak dapat memproses permintaan karena koneksi API Key bermasalah. Saya hanya dapat menjawab pertanyaan bawaan seperti 'cara membuat anggaran' atau 'cara menabung'.";
}
